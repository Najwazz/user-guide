...
class CatsControllerTest < ActionController::TestCase
  ...
  test "should create cat" do
    assert_difference('Cat.count') do
      post :create, cat: { description: @cat.description, name: @cat.name, short_name: @cat.short_name }
    end
  ...
  test "should update cat" do
    put :update, id: @cat, cat: { description: @cat.description, name: @cat.name, short_name: @cat.short_name }
    assert_redirected_to cat_path(assigns(:cat))
  end
